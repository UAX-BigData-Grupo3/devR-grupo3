...
Correlación entre edad y tamaño del tumor y si sobrevive o muere

```{r}
cor(df_cancer$Age, df_cancer$Status, method = c("pearson", "kendall", "spearman"))
cor(df_cancer$`Tumor Size`, df_cancer$Status, method = c("pearson", "kendall", "spearman"))
```
