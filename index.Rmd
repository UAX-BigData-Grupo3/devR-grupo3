...
titanic_transform$Age[is.na(titanic_transform$Age)] <- mean(titanic_transform$Age, na.rm = T)
```
...
titanic_transform <- titanic_transform %>% mutate(Sex = replace(Sex, Sex == "female", 0))
titanic_transform <- titanic_transform %>% mutate(Sex = replace(Sex, Sex == "male", 1))
```
